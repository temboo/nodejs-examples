...
Each example  in this repo is a separate simple app that demonstrates using the Temboo Node.js SDK to interact with different 3rd party APIs and services. 
...
###Quickstart
 ...
 2. Download the Temboo Node.js SDK from [www.temboo.com/download](https://www.temboo.com/download) and install it in your IDE of choice
 3. Clone the repo: `git clone git@github.com:temboo/nodejs-examples.git`
